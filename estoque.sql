...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 31-Out-2021 às 01:31
...
CREATE TABLE IF NOT EXISTS `estoque` (
  ...
  `mod_fab` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Ford', 'Ka', '1.0 MPI 8V FLEX 2P MANUAL', '', 'branco', 'GHF9845', 18000),
(2, 'Toyota', 'Corola', '1.8 SE-G 16V FLEX 4P AUTOMÁTICO', '', 'preto', 'KZY4638', 38000);
COMMIT;
